 <div class="container-fluid">
 	...
 	<div class="row">
 		...
 		<div class="col-md-8">
			...
			echo base_url('index.php/Registration/edit/').$editInfo->user_id;}else{  echo base_url('index.php/Registration/add'); } ?>" enctype="multipart/form-data">
 				<?php
 				...
 				<div class="form-group row">
 					...
 					<div class="col-sm-4">
						 ...
						 <button class="btn btn-danger"><a href="<?php echo base_url('index.php/Registration/table/');?>" class="textCls">Back</a> </button>
 					</div>
 				</div>
